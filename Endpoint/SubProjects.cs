namespace RentmanSharp.Endpoint
{
    ...
    /// </summary>
    public class SubProjects : AbstractEndpoint<Entity.SubProject, Facade.SubProject>
    {
        ...
        public async Task<Facade.ProjectEquipmentGroupItem[]> GetLinkedProjectEquipmentGroupCollectionEntity(uint id, Filter? filter = null)
        {
