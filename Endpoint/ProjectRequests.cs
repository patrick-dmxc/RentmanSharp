...
namespace RentmanSharp.Endpoint
{
    ...
    /// </summary>
    public class ProjectRequests : AbstractEndpoint<Entity.ProjectRequest, Facade.ProjectRequest>
    {
        ...
        public async Task<Facade.ProjectRequestEquipmentItem[]> GetLinkedProjectRequestEquipmentCollectionEntity(uint id, Filter? filter = null)
        {
